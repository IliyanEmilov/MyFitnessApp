...
public class DBAdapter {
    ...
    /* 01 Променливи */
    private static final String databaseName = "myfitnessapp";
    private static final int databaseVersion = 1;

    /* 02 Променливи на база данни ------------------------------- */
    private final Context context;
    private DatabaseHelper DBHelper;
    private SQLiteDatabase db;


    /* 03 Клас DatabaseAdapter ---------------------------------- */
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            // ! Всички таблици, които ще бъдат премахнати, трябва да бъдат изброени тук
    ...
    public String quoteSmart(String value){
        ...
        if(isNumeric == false){
            // Премахване на специални знаци в стринга за използване в SQL statement
    ...
    */
    ...
    public boolean update(String table, String primaryKey, long rowId, String field, String value) throws SQLException {
        ...
        // Премахване на първата и последната стойност на стойността
        value = value.substring(1, value.length()-1); // премахва апостроф след изпълнение на quote smart
    ...
    public boolean update(String table, String primaryKey, long rowID, String fields[], String values[]) throws SQLException {
        ...
        for(int x=0;x<arraySize;x++){
            // Премахнете първата и последната стойност на стойността
            values[x] = values[x].substring(1, values[x].length()-1); // премахване на апостроф след изпълнение на quote smart
