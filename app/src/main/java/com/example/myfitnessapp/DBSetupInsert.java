...
public class DBSetupInsert {
    ...
    /* Настройване на Вмъкване в категории ----------------------------------------- */
    // За вмъкване в таблицата с категории
    ...
    /* Настройване на вмъкване към храна ----------------------------------------------- */
    // вмъкване на храна в таблицата с храни
    ...
    // Вмъкване на всички храни в база данни за храни
